    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <main className="max-w-4xl mx-auto px-6 py-10">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link href="/buy" className="px-4 py-2 bg-green-700 text-white text-sm rounded-lg hover:bg-green-800">
            + Post requirement
          </Link>
        </div>
        ...
        {(!requirements || requirements.length === 0) && (
          <div className="text-center py-20">
            <p className="text-gray-400 text-lg mb-4">No buyer requirements posted yet.</p>
        ...
        <div className="space-y-4">
          {requirements?.map((req) => (
            <div key={req.id} className="border rounded-lg p-5 hover:shadow-sm transition-shadow">
