            ...
            return (
              <div key={req.id} className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-md">
                ...
                <div className="mt-4 flex flex-wrap items-center gap-2 border-t border-gray-100 pt-3">
                  ...
                  {wa && (
                    <a href={`https://wa.me/91${wa}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 rounded-full bg-green-700 px-4 py-1.5 text-sm font-medium text-white transition-colors hover:bg-green-800">
                      💬 WhatsApp
                    </a>
                  )}
