  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        {listing.agent_id && (
          <p className="mb-1"><span className="inline-flex items-center gap-1 rounded-full bg-amber-100 px-2 py-0.5 text-xs font-semibold text-amber-800">🤝 Agent</span></p>
        )}
