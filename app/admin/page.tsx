    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <main className="max-w-5xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
          <div className="bg-white p-5 rounded-lg border text-center"><p className="text-3xl font-bold text-green-800">{listings?.length ?? 0}</p><p className="text-sm text-gray-500">Listings</p></div>
          <div className="bg-white p-5 rounded-lg border text-center"><p className="text-3xl font-bold text-green-800">{verified}</p><p className="text-sm text-gray-500">Verified</p></div>
          <div className="bg-white p-5 rounded-lg border text-center"><p className="text-3xl font-bold text-blue-700">{inquiries?.length ?? 0}</p><p className="text-sm text-gray-500">Inquiries</p></div>
          <div className="bg-white p-5 rounded-lg border text-center"><p className="text-3xl font-bold text-amber-700">{buyers?.length ?? 0}</p><p className="text-sm text-gray-500">Buyer reqs</p></div>
        </div>
